...
int main(){  
    ...
    // mi ans = (3*be(x, 6)+be(x, 5)+be(x, 4)+1) / ((1-be(x, 4))*be((1-be(x, 3)), 2)*be((1-be(x, 2)), 2)*(1-x));
    mi ans = be(f(x),6)+6*be(f(x),2)*f(be(x,4))+3*be(f(x),2)*be(f(be(x,2)),2)+8*be(f(be(x,3)),2)+6*be(f(be(x,2)),3)/24;
